...
const TestThemeBlock = () => {
	...
	return (
		<div>
			<div className="font-semibold text-[24px] mb-6 text-theme-primary-active">{t('appearance')}</div>
				...
				<div className="test-item flex px-5 mt-[-15px]">
					...
					<div className="test-right ml-3">
						<div className="test-right-top flex gap-3 items-center">
							...
							<div className="test-right-top-time text-[12px]  ">{t('todayAt')} {realTime}</div>
						</div>
