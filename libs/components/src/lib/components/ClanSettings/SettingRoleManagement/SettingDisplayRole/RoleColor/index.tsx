		...
		<div className="w-full flex flex-col text-[15px] dark:text-textSecondary text-textSecondary800 pr-0 md:pr-5">
			...
			<div className="w-full flex flex-col md:grid md:grid-cols-10 gap-2">
				<div className="flex flex-row md:contents gap-2">
					<button
						className="flex-1 md:col-span-2 h-[40px] md:h-[50px] rounded relative"
					...
					<div className="flex-1 md:col-span-2 h-[40px] md:h-[50px] relative inline-block cursor-pointer rounded">
						<input
							type="color"
							ref={colorInputRef}
							value={selectedColor}
				...
				<div className="md:col-span-6 grid grid-cols-7 md:grid-cols-10 gap-2">
					{colorArray.map((color, index) => (
						<button
							key={index}
							className="w-[24px] h-[24px] md:w-[20px] md:h-[20px] rounded relative"
