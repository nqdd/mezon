		...
		>
			{
				<Link
					...
					onClick={handleClick}
					className={`channel-link block  rounded-lg mt-[0.2rem] text-theme-primary-hover  ${classes[state]} ${isActive || numberNotification ? 'bg-item-theme text-theme-primary-active' : 'text-theme-primary'}`}
					draggable="false"
				>
					<span
						ref={channelLinkRef}
