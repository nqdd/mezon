...
export const Send: React.FC<IconProps> = ({ defaultSize = 'w-5 h-5', defaultFill = '' }) => {
	return (
		<svg aria-hidden="true" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={defaultSize} fill="none">
			<path
				d="M11.5003 12H5.41872
				...
				C5.38768 12.375 5.34057 12.5157 5.24634 12.7972Z"
				stroke={defaultFill || 'currentColor'}
				strokeWidth="2"
				strokeLinecap="round"
				strokeLinejoin="round"
			/>
