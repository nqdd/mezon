...
export const ArrowRight: React.FC<IconProps> = ({ defaultSize = 'w-5 h-5 min-w-4', className }) => {
	return (
		<svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" className={className ? `${defaultSize} ${className}` : defaultSize}>
			<g id="Live area">
				<path
					id="Vector"
					fillRule="evenodd"
...
export const RightIcon: React.FC<IconProps> = ({ defaultFill = '#AEAEAE', defaultSize = 'w-5 h-5' }) => {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" className={`${defaultSize}`}>
			<path
				fillRule="evenodd"
			...
			<g className="layer">
				...
				<g className="layer 2" id="svg_6" transform="matrix(1 0 0 1 0 0) matrix(0.939693 -0.34202 0.34202 0.939693 0.0727787 65.7849)">
					...
					<g clipPath="url(#svg_2)" id="svg_14">
						...
						<g clipPath="url(#svg_8)" fill="#5865f2" id="svg_18">
...
export function Sparkles(props: React.HTMLAttributes<SVGElement>) {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 56 56" {...props}>
...
export function School(props: React.HTMLAttributes<SVGElement>) {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="24" height="24" viewBox="0 0 15 15" {...props}>
			<path d="M11 13v-1h2v-1H9.5v-1H13V9h-2V8h2V7h-2V6h2V5H9.5V4H13V3h-2V2h2V1H8v13h5v-1zm-5-2H2V1h4zm0 1-2 2-2-2z" />
		</svg>
	);
}

export function Community(props: React.HTMLAttributes<SVGElement>) {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="24" height="24" viewBox="0 0 256 256" {...props}>
			<path d="M192.498 124.8c9.278 0 16.8 7.522 16.8 16.8s-7.522 16.8-16.8 16.8-16.8-7.522-16.8-16.8 7.522-16.8 16.8-16.8m-20.7 41.8c9.278 0 16.8 7.522 16.8 16.8s-7.522 16.8-16.8 16.8-16.8-7.522-16.8-16.8 7.522-16.8 16.8-16.8m-26.8 36.7h-37.8c-11.5 0-18.7 9.5-18.7 21.4V254h12.9v-25.9c0-1.2 1-2 2-2 1.2 0 2 .8 2 2v25.8h41.5v-25.8c0-1.2 1-2 2-2 1.2 0 2 1 2 2v25.8h12.9v-29.1c.2-12-7.1-21.5-18.8-21.5m4.7-78.5c9.278 0 16.8 7.522 16.8 16.8s-7.522 16.8-16.8 16.8-16.8-7.522-16.8-16.8 7.522-16.8 16.8-16.8m49.4 58.6c0 9.3 7.5 16.8 16.8 16.8s16.8-7.5 16.8-16.8-7.5-16.8-16.8-16.8-16.8 7.5-16.8 16.8m-1.7 19.9c-11.5 0-18.7 9.5-18.7 21.4V254h12.9v-25.9c0-1.2 1-2 2-2 1.2 0 2 .8 2 2v25.8h41.5v-25.8c0-1.2 1-2 2-2 1.2 0 2 1 2 2v25.8h12.9v-29.1c.2-12.1-7.1-21.6-18.7-21.6h-37.9zm-157.6-36.7c9.278 0 16.8 7.522 16.8 16.8s-7.522 16.8-16.8 16.8-16.8-7.522-16.8-16.8 7.522-16.8 16.8-16.8m-25 87.3v-25.8c0-1.2 1-2 2-2 1.2 0 2 .8 2 2v25.8h41.5v-25.8c0-1.2 1-2 2-2 1.2 0 2 1 2 2v25.8h12.9v-29.1c.2-12.1-7.1-21.6-18.7-21.6h-37.8c-11.5 0-18.7 9.5-18.7 21.4v29.3zm94.5-70.5c0 9.3 7.5 16.8 16.8 16.8s16.8-7.5 16.8-16.8-7.5-16.8-16.8-16.8-16.8 7.5-16.8 16.8m-48-58.6c9.278 0 16.8 7.522 16.8 16.8s-7.522 16.8-16.8 16.8-16.8-7.522-16.8-16.8 7.522-16.8 16.8-16.8m45.4 0c9.278 0 16.8 7.522 16.8 16.8s-7.522 16.8-16.8 16.8-16.8-7.522-16.8-16.8 7.522-16.8 16.8-16.8m-22.6 41.8c9.278 0 16.8 7.522 16.8 16.8s-7.522 16.8-16.8 16.8-16.8-7.522-16.8-16.8 7.522-16.8 16.8-16.8M128 2C99.327 2 76 25.327 76 54s23.327 52 52 52 52-23.327 52-52-23.327-52-52-52m38.457 32.067h-14.072c-1.158-5.359-2.784-10.311-4.845-14.62a44 44 0 0 0-3.148-5.55c9.52 3.905 17.346 11.102 22.065 20.17M171.333 54c0 4.212-.615 8.281-1.741 12.133h-15.889c.484-3.924.736-7.992.736-12.133 0-3.838-.22-7.611-.636-11.267h16.035A43.2 43.2 0 0 1 171.333 54M128 95.889c-5.758 0-11.964-8.072-15.305-21.089h30.61c-3.341 13.017-9.547 21.089-15.305 21.089m-16.973-29.756a91 91 0 0 1-.8-12.133c0-3.963.244-7.73.684-11.267h34.178c.44 3.537.684 7.304.684 11.267 0 4.29-.288 8.347-.8 12.133zM84.667 54c0-3.897.525-7.672 1.495-11.267h16.035A100 100 0 0 0 101.561 54c0 4.142.252 8.209.736 12.133H86.408A43.2 43.2 0 0 1 84.667 54M128 12.111c5.884 0 12.233 8.434 15.517 21.955h-31.034c3.284-13.52 9.633-21.955 15.517-21.955m-16.393 1.785a44 44 0 0 0-3.148 5.55c-2.061 4.309-3.687 9.261-4.845 14.62H89.543c4.719-9.067 12.545-16.264 22.064-20.17M89.997 74.8H103.8c1.144 5.028 2.71 9.676 4.66 13.753a44 44 0 0 0 3.148 5.55A43.6 43.6 0 0 1 89.997 74.8m54.396 19.304a44 44 0 0 0 3.148-5.55c1.95-4.077 3.516-8.725 4.66-13.753h13.802a43.6 43.6 0 0 1-21.61 19.303" />
		</svg>
	);
}

export function PaintTray(props: React.HTMLAttributes<SVGElement>) {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="24" height="24" viewBox="0 0 512 512" {...props}>
