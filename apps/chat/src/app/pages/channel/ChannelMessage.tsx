...
import { TIME_COMBINE, TypeMessage } from '@mezon/utils';
...
export const ChannelMessage: ChannelMessageComponent = ({
	...
	const isTimeGreaterThan60Minutes =
		!!message?.create_time && Date.parse(message.create_time) - Date.parse(previousMessage?.create_time) < TIME_COMBINE;
