	...
	const features = [
		{
			...
			description: 'Experience crystal-clear audio with advanced noise suppression and echo cancellation technology.',
			image: '/assets/voice-channel.webp'
		},
		{
			id: 1,
			title: 'Screen Sharing',
			description: 'Share your screen to present ideas or collaborate on projects in real-time with your team.',
			image: '/assets/voice-channel.webp'
		},
		{
			id: 2,
			title: 'Video Calls',
			description: 'Switch to video anytime for face-to-face conversations with your team members.',
			image: '/assets/voice-channel.webp'
		},
		{
			id: 3,
			title: 'Low Latency',
			description: 'Minimal delay ensures natural conversations flow smoothly, making it feel like you are in the same room.',
			image: '/assets/voice-channel.webp'
		}
	];
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
						<div className="max-lg:text-center">
							<h1 className="text-7xl max-lg:text-5xl max-md:text-4xl font-bold mb-8 leading-tight">
								Crystal clear <span className="text-purple-600 block mt-2">Voice Channels</span>
							</h1>
							<p className="text-xl max-md:text-lg text-gray-600 leading-relaxed mb-10 max-w-xl">
								Crystal clear voice communication for your team. Join voice channels instantly and talk with your friends or
								colleagues with high-quality audio.
							</p>
							<a
								href={downloadUrl}
			...
			<section className="py-20 max-md:py-12 px-4 bg-[#F8F9FA]">
				<div className="container max-w-7xl mx-auto">
					<div className="max-w-4xl mx-auto">
						<h2 className="text-4xl max-md:text-3xl font-bold text-center mb-12">Premium voice communication features</h2>
						<div className="space-y-8">
							<div className="flex gap-6 max-md:flex-col">
								<div className="flex-1">
									<h3 className="text-xl font-semibold text-gray-900 mb-3">Low Latency</h3>
									<p className="text-gray-600 leading-relaxed">
										Minimal delay ensures natural conversations flow smoothly, making it feel like you're in the same room.
									</p>
								</div>
							</div>
							<div className="flex gap-6 max-md:flex-col">
								<div className="flex-1">
									<h3 className="text-xl font-semibold text-gray-900 mb-3">Push to Talk</h3>
									<p className="text-gray-600 leading-relaxed">
										Use push-to-talk mode for a walkie-talkie experience, perfect for gaming or quick team check-ins.
									</p>
								</div>
							</div>
							<div className="flex gap-6 max-md:flex-col">
								<div className="flex-1">
									<h3 className="text-xl font-semibold text-gray-900 mb-3">Voice Activity Detection</h3>
									<p className="text-gray-600 leading-relaxed">
										Automatic voice activation so you don't have to press any buttons. Just speak naturally and be heard.
									</p>
								</div>
							</div>
						</div>
			...
			<section className="py-20 max-md:py-12 px-4">
				<div className="container max-w-7xl mx-auto text-center">
					<h2 className="text-4xl max-md:text-3xl font-bold mb-6">
						Ready to start <span className="text-purple-600">talking</span>?
					</h2>
					<p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
						Join Mezon today and experience crystal-clear voice communication with your team.
					</p>
					<Link
						to="/mezon"
