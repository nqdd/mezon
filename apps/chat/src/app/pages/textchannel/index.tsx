  ...
  `;
	...
	return (
		<div className="min-h-screen bg-white">
			...
			<section ref={section5Ref} className="section-animate relative w-full bg-white py-20 max-md:py-12 2xl:py-[193px] overflow-hidden">
				<div className="max-w-[1600px] 2xl:max-w-[2400px] mx-auto px-10">
					<div className="flex items-center justify-between 2xl:justify-around max-lg:flex-col-reverse max-lg:gap-12 gap-8 lg:gap-12 xl:gap-16">
						<div className="image-animate flex-shrink-0">
							<img
					...
					<div className="grid grid-cols-1-reverse lg:grid-cols-2 gap-8 lg:gap-16 items-center">
						<div className="space-y-6 lg:space-y-8 relative z-10 order-1 lg:order-1">
							<div className="space-y-4">
								<h2 className="font-svnAvo text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-slate-900 leading-tight">
									{t('discover.title')}
								</h2>
								<p className="font-svnAvo text-base sm:text-lg md:text-xl text-slate-600 leading-relaxed max-w-lg">
												...
												>
													<div className="bg-white rounded-[63px] lg:rounded-[35px]  overflow-hidden flex flex-col h-full">
														...
														<div className="p-4 sm:p-5 md:p-6 space-y-2 sm:space-y-3 flex-grow flex flex-col">
															<h3 className="text-lg sm:text-xl font-bold text-slate-900 line-clamp-2 min-h-[3rem] sm:min-h-[3.5rem]">
																{slide.title}
															</h3>
															<p className="font-svnAvo text-sm sm:text-base text-slate-600 line-clamp-3 min-h-[3.5rem] sm:min-h-[4.5rem]">
																{slide.description}
															</p>
														</div>
													</div>
